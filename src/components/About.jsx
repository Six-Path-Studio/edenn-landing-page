...
const About = () => {
  ...
  return (
    <section className="lg:px-24 px-4">
      <div className="my-6 sm:mx-4 text-center">
      ...
      <div id="about" className="bg-white lg:flex p-6 justify-between rounded-[28px]">
      ...
      <div className="lg:flex justify-between my-6">
        <div id="abt1" className="lg:w-[48%] lg:px-20 px-10 text-white pt-10 bg-[#1C1A1A] lg:rounded-[28px] rounded-[16px]">
        ...
        <div id="abt2" className="lg:w-[48%] bg-[#7247B3] lg:px-20 px-10 sm:mt-6 pt-10 border border-[#7247B3] rounded-[28px]">
      ...
      <div className="lg:flex justify-between lg:my-10 my-6">
        <div id="abt4" className="lg:w-[48%] lg:px-20 px-10 text-white pt-10 bg-[#1C1A1A] lg:rounded-[28px] rounded-[16px]">
        ...
        <div id="abt1" className="lg:w-[48%] bg-[#7247B3] lg:px-20 px-10 sm:mt-6 pt-10 border border-[#7247B3] rounded-[28px]">

...
const Hero = () => {
  return (
    <section id="hero" className="bg-[#0A0A0A] lg:px-24 lg:py-6 ">
      ...
      <div className="lg:flex sm:px-8 lg:my-20 justify-center text-center sm:mt-20">
        <div className="my-auto lg:w-[65%] sm:text-center">
          <div className="flex lg:w-[65%] justify-evenly mb-10 mx-auto border border-white p-2 rounded-xl">
            <img src="/images/icon.png" className="mr-2 sm:my-auto" alt="" />
            <p className="capitalize text-white sm:text-sm">showcasing creatives, and possibilities across Africa</p>
          </div>
